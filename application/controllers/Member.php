...
class Member extends CI_Controller
{
	...
	public function postdata()
	{
		if ($this->input->server('REQUEST_METHOD') == TRUE) {
			...
			// $this->form_validation->set_rules('firsname', 'ชื่อ', 'required', array('required'=> 'ค่าห้ามว่าง!'));
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$this->member_model->entry_member($this->input->post('id'));
				redirect('member', 'refresh');
			} else {
				$data = array(
					'error_name' => form_error('firsname'),

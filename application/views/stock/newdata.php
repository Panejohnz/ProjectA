<div class="content-wrapper">
	...
	<div class="container">
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<form role="form" action="<?php echo base_url('stock/adding'); ?>" method="post" enctype="multipart/form-data">
				<div class="box-body">
				...
				<div class="box-footer">
					...
					<a class="btn btn-danger" href="<?php echo base_url('stock'); ?>" role="button">

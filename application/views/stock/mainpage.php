<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo  base_url('stock'); ?>"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
            <li class="active">สินค้าใกล้หมด</li>
        </ol>
    </section>
    <!-- Top menu -->
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-success" href="<?php echo  base_url('stock/newdata'); ?>" role="button"><i class="fa fa-fw fa-plus-circle"></i> เพิ่มข้อมูล</a>
                            <a class="btn btn-default" href="<?php echo  base_url('stock'); ?>" role="button"><i class="fa fa-fw fa-refresh"></i> Refresh Data</a>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <tbody>
                                    <?php if(!empty($results)){ foreach ($results as $data) { ?>
                                        <tr role="row">
                                            ...
                                            <a href="<?php echo base_url('stock/edit/'.$data['img_id']); ?>">
                                            ...
                                            <td>
                                             <a class="btn btn-danger btn-xs" href="<?php echo  base_url('stock/confrm/'.$data['img_id']); ?>" role="button"><i class="fa fa-fw fa-trash"></i> ลบข้อมูล</a>
                                            </td>
                                        </tr>
                                    <?php } } ?>
                                </tbody>

<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url("index.php/Admin");?>"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
            <li><a href="<?php echo  base_url('index.php/Admin'); ?>">จัดการ admin </a></li>
    ...
    <div class="container">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="<?php echo  base_url('index.php/admin/postdata'); ?>" method="post">
                <div class="box-body">

...
<body>
    ...
    <div id="page-wrap ">
        ...
        <div id="identity">
            ...
            <p>ชื่อ <?php echo $this->session->userdata('firsname');?></p>
            <p>ที่อยู่ <?php echo $this->input->post('address'); ?></p>
            <p>เมล <?php echo $this->input->post('email'); ?></p>
            <p>เบอร์ <?php echo $this->input->post('phone'); ?></p>

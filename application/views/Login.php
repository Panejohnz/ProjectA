    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <form name="login" id="login_form" method="post" action=<?php echo base_url('index.php/TestController/Login') ?>>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="usertxt" id="usertxt" placeholder="Email/Username" required class="form-control">

...
<html>
  ...
  <body>
    <nav id="topNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#first"><i class="ion-ios-analytics-outline"></i> 20october</a>
            </div>
            <div class="navbar-collapse collapse" id="bs-navbar">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="nav-link" href=<?php echo site_url("welcomecontroller");?>>Intro</a>
                    </li>
                    <li>
            ...
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="./assets/deer.jpg">
                        <img src="<?php echo base_url(); ?>./assets/images/person_2.jpg" class="img-responsive" alt="Image 1">
    ...
    <script src="<?php echo base_url('./assets/js1/jquery.easing.min.js');?>"></script>
    <script src="<?php echo base_url('./assets/js1/wow.js');?>"></script>
    <script src="<?php echo base_url('./assets/js1/scripts.js');?>"></script>

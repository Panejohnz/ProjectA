                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                <tbody>
                                    <?php if(!empty($results)){ foreach ($results as $data) { ?>
                                        <tr role="row">
                                            <td>
                                            <a href="<?php echo base_url('index.php/imgtype/edit/'.$data->imgtype_id); ?>">
                                            ...
                                            <td>
                                            	<a class="btn btn-danger btn-xs" href="<?php echo  base_url('index.php/imgtype/confrm/'.$data->imgtype_id); ?>" role="button"><i class="fa fa-fw fa-trash"></i> ลบข้อมูล</a>
                                            </td>
                                        </tr>
                                    <?php } } ?>
                                </tbody>

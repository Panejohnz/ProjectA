<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="col-md-9">
			<form role="form" action="<?php echo  base_url('orders/postdata'); ?>" method="post" class="form-horizontal">
			...
			<div class="col-sm-8">
				...
				<div class="box-footer">
					...
					<a class="btn btn-danger" href="<?php echo  base_url('orders'); ?>" role="button">

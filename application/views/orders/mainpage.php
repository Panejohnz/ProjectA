        ...
        <div class="box">
            ...
            <div class="box-body">
                <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-default" href="<?php echo  base_url('index.php/orders'); ?>" role="button"><i class="fa fa-fw fa-refresh"></i> Refresh Data</a>
                        </div>
                        <div class="col-sm-6">
                                    ...
                                    <?php if(!empty($results)){ foreach ($results as $data) { ?>
                                        <tr role="row">
                                            ...
                                            <?php //สถานะ
                                             ...
                                             if($status == 1){
                                                ?>
                                                <a href="Orders/update_status?sid=<?php echo $data->id;?>&sval=<?php echo $data->status; ?>" class="btn btn-success">ชำระเงินเรียบร้อยแล้ว</a>
                                             <?php
                                             }else{
                                                 ?>
